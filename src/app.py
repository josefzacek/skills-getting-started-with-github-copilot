...
activities = {
    ...
    "Basketball Team": {
        "description": "Team practices, drills, and competitive games against other schools",
    ...
    "Debate Team": {
        "description": "Competitive debating, public speaking, and argumentation practice",
...
def signup_for_activity(activity_name: str, email: str):
    ...
    # Ensure activity exists before checking participants
